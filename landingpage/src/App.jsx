...
import cmplogo from "../src/assets/brandlogo.jpg";
...
const scrollToSection = (ref) => {
  ...
  return (
    <>
        <a href="https://wa.me/917449213799" class="whatsapp-fixed" target="_blank" rel="noopener noreferrer">
...
<nav className="navbar">
  ...
  <ul className={`navbar-menu ${menuOpen ? 'open' : ''}`}>
    <li><a onClick={() => scrollToSection(section5Ref)}>About Us</a></li>
    <li><a onClick={() => scrollToSection(section1Ref)}>Why Mr Franchise</a></li>
    <li><a onClick={() => scrollToSection(section2Ref)}>What you get</a></li>
    <li><a onClick={() => scrollToSection(section3Ref)}>Download </a></li>
    <li><a onClick={() => scrollToSection(section4Ref)}>Associates Partners</a></li>
    <li><a onClick={openModal}>Contact us</a></li>
  </ul>
</nav>
{/* Modal for Lead Form */}
<ReactModal
...
<LeadForm onSuccess={handleFormSubmit} /> {/* Render your lead form here */}
</ReactModal>
      {/* Section 1: Hero and Banner */}
      <div  className="section-1" style={{backgroundImage:`url(${back1})`,backgroundSize:"cover" ,backgroundRepeat:"no-repeat" ,backgroundPosition:"center" ,height:"400px",opacity:" 0.9"}}  >
        <div
          className="hero-section"  
        >
          <h1>Franchise Your Business With Expert Support</h1>
          <h3>Turn your <b style={{ color: 'orange'}}>Successful Business </b>into a <br /> <b style={{ color: 'orange' }}>Scalable Franchise</b> with <b style={{color:"orange"}}>MR FRANCHISE</b></h3>
          <button style={{ backgroundColor: '#27d808', color: 'white', marginTop:"20px",fontSize:"1.5rem" }}  onClick={openModal}>Free Franchise Consultation ➔ </button>
        </div>
          ...
          <div className="banner">
            ...
            <ul>
              {items.map((item, index) => (
                <li key={index} className={index === activeItem ? 'pulse-active' : ''}>
                  {item}
                </li>
              ))}
            </ul>
              ...
              <div className="mind-map-body">
                <div className="mind-map-nodes">
                  ...
                  <div className="mind-map-node node-2">
                    <div className="node-icon">✓</div>
                    <h4 className="node-title">10+ Years of Franchise Experience</h4>
                  </div>
                  <div className="mind-map-node node-3">
                    <div className="node-icon">✓</div>
                    <h4 className="node-title">25+ Years of Sales and Business Development</h4>
                  </div>
                  <div className="mind-map-node node-4">
                    <div className="node-icon">✓</div>
                    <h4 className="node-title">Strong Regional Investor Base</h4>
                  </div>
                  <div className="mind-map-node node-5">
                    <div className="node-icon">✓</div>
                    <h4 className="node-title">Local & Scalable Advisory Services</h4>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="section-3" >
        ...
        <div className="partners-section" ref={section4Ref}>
          ...
          <div className="partners" ref={scrollRef}>
            {[logo1, logo2, logo3, logo4, logo5, logo6, logo7, logo8, logo9, logo10, logo11, logo12, logo13].map((logo, i) => (
    ...
    <div className="company-description">
      ...
      <div className="company-stats">
        <div className="stat-item">
          ...
          <div className="stat-label">Years <br/>In Sales <br /> Marketing</div>
        </div>
        <div className="stat-item">
          <div className="stat-number">10+</div>
          <div className="stat-label"> Years <br /> In Business <br /> Development</div>
        </div>
        <div className="stat-item">
          <div className="stat-number">50+</div>
          <div className="stat-label">Franchise <br />Launched <br /> Consulted</div>
        </div>
       
        <div className="stat-item">
          <div className="stat-number">7+</div>
          <div className="stat-label">Years <br /> Franchise <br />  Consultation </div>
        </div>
      ...
      <div className="stat-item-2">
          ...
          <div className="stat-label-2">Years <br /> Franchise <br /> Exhibitions</div>
        </div>
        <div className="stat-item-2">
          <div className="stat-number-2">2+</div>
          <div className="stat-label-2">Lead Generation <br /> Platform <br /> <a style={{color:"orange"}} >"www.MrFranchise.in"</a></div>
        </div>
        <div className="stat-item-2">
          <div className="stat-number-2">2+</div>
          <div className="stat-label-2">Years In <br /> Franchise <br /> Recruitment</div>
        </div>
        </div>
  </div>
</div>
